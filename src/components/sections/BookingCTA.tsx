    ...
    <section id="booking" className="py-[clamp(3rem,8vw,6rem)] bg-navy text-white text-center scroll-mt-24">
      <div className="container-ag flex flex-col gap-14">
        <div className="max-w-[36ch] mx-auto">
          ...
          <h2 className="font-[family-name:var(--font-display)] text-[clamp(2rem,4vw,3rem)] leading-[1.1] tracking-[-0.015em] text-white mb-5">
            {t(dictionary.booking.title, locale)}
          </h2>
          <p className="text-[rgba(255,255,255,0.65)] text-[19px] leading-relaxed max-w-[60ch] mx-auto mb-8">
