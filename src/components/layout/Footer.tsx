...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface border-t border-[#DDE2E8] py-14 text-muted text-xs">
      <div className="container-ag">
        ...
        <hr className="border-t border-[#DDE2E8] my-6" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <span className="font-[family-name:var(--font-mono)] text-[11px]">
            Developed with ❤️ by <a href="https://kentodevlab.com" target="_blank" rel="noopener noreferrer" className="text-blue-bright hover:underline">KentoDevLab</a>
          </span>
        </div>
      </div>
    </footer>
