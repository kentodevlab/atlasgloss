...
export default function ServiceCard({ service }: ServiceCardProps) {
  ...
  const bezelOuter = `relative rounded-[1.75rem] p-[2px] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 ${service.featured ? 'bg-blue-bright' : 'bg-black/[0.04] dark:bg-white/[0.06]'}`

  return (
    <div className={bezelOuter}>
      <div className={`bg-card rounded-[calc(1.75rem-4px)] p-5 md:p-8 text-center flex flex-col shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_12px_32px_rgba(15,37,71,0.16),0_4px_8px_rgba(15,37,71,0.06),inset_0_1px_0_rgba(255,255,255,0.12)]`}>
